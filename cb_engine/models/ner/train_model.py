...
x_train = sequence.pad_sequences(x_train, padding='post', maxlen=40)
y_train = sequence.pad_sequences(y_train, padding='post', maxlen=40)
...
model.add(Embedding(input_dim=voca_size, output_dim=30, input_length=40, mask_zero=True))
